...
public class CreateLikePostTest extends FunctionalTests {
    ...
    @Test
    void createLikePostWithProperDataReturnsOKStatus() {
    ...
    @Test
    void createLikePostByUserWithStatusNEWReturnsBadRequestStatus() {
        given().accept(ContentType.JSON)
                .header("Content-Type", "application/json;charset=UTF-8")
    ...
    @Test
    void createLikePostByOwnerOfPostReturnsBadRequestStatus() {
        given().accept(ContentType.JSON)
                .header("Content-Type", "application/json;charset=UTF-8")
